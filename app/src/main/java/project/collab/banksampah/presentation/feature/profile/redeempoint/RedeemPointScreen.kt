...
import project.collab.banksampah.presentation.feature.profile.redeempoint.components.TotalPointErrorCard
    ...
    Scaffold(
        ...
        Column(
            ...
            RedeemPointForm(
                ...
                isLoading = exchangePointState.isLoading
            )
        }
        ...
        exchangePointState.data?.let { data ->
            RedeemSuccessDialog(
                ...
                onNavigateToRedeemPointHistory = onNavigateToRedeemPointHistory
            )
        }
    }
}
